import img from '../../../assets/images/modelos-renders/ai2.webp'
import plano from '../../../assets/images/modelos-planos/ai2p.webp'
import CardModel from '../CardModel';

export const CardAI2 = () => {


    const modelName = 'Smart AI - 2';
    const images = [img, plano];
    const details = [
      { icon: 'fas fa-ruler', text: '75 m²' },
