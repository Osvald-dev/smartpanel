...
import img5 from '../../../assets/images/modelos-renders/sp-c3.webp'
...
export const CardC3 = () => {
    ...
    return (
        <div className="container-full bg-modelo">
            ...
            <div id="carouselExampleFade12" className="carousel slide ">
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleFade12" data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>
                <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleFade12" data-bs-slide="next">
                    <span className="carousel-control-next-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Next</span>
                </button>
            </div>
            <div className="row">
                <h2 className='name-model'> C3</h2>
