...
import sanjose from '../../assets/images/entrerios-sanjose.png'
import santafe from '../../assets/images/santafe-3.png'
import santafe1 from '../../assets/images/santafe.png'
                ...
                <div className="texto-div">
                    ...
                    <div className="col-lg">
                        ...
                        <div className="card-container">
                            ...
                            <div className="card-set">
                                <img src={sanjose} alt="construcción en seco San José Entre Ríos Woodframe" className="card-image-set" />
                            </div>
                            <div className="card-set">
                                <img src={santafe} alt="construcción en seco Santa Fe Woodframe" className="card-image-set" />
                            </div>
                            <div className="card-set">
                                <img src={santafe1} alt="construcción en seco Santa Fe Woodframe" className="card-image-set" />
                            </div>
                        </div>
